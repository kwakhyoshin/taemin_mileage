...
| 항목 | 스크린샷 | 내용 |
|------|---------|------|
| **C5: 다크모드 상태 변화 없음** | 021-C5-dark-on.png | before=after=false |
| **D3: 네비 잘림** | 029-D3-nav-layout.png | x:-183, w:366, right:183 |
| **E3: 취소 (건너뜀)** | 032-E2-no-act.png | E2 실패 |

### 🔧 테스트 코드 개선 필요 (6건)

| 항목 | 비고 |
|------|------|
| D2: 활동탭 | 현재 data-tab="home" |
| D2: 보상탭 | 현재 data-tab="home" |
| D2: 리포트탭 | 현재 data-tab="home" |
| D2: MY탭 | 현재 data-tab="home" |
| E2: 완료할 활동 없음 |  |
| G1: 프로필 | DEV
mile.ly
가족 계정으로 로그인하세요
