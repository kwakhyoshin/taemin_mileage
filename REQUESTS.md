...
| R-076 | 2026-04-17 | 통합모드(shared) 완전 제거 — 항상 독립모드로 운영 | v0417e | PR #404 반영 | 관리자 모드 섹션 UI 제거, 가족 생성 모드 선택 Step 4 제거, getFamilyMode()==='independent' 분기 간소화, mode-card/toss-mode CSS 제거 (~104줄 감소) |
